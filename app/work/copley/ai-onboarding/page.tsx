  ...
  return (
    ...
    >
      ...
      <Section>
        ...
        <PullQuote
          quote="Users don't need to be convinced AI is good. They need to feel in control while it's working."
          emphasisWord="feel in control"
          source="— Design principle guiding the entire flow"
          accentColor="#0284c7"
        />
      </Section>
      ...
      <Section>
        ...
        <DotLabel color="#0284c7">Original vs Redesigned Flow</DotLabel>
        <ImgBox
          label="Flow map — original 7-step form-first vs new 5-step value-first flow"
          hexColor="#22c55e"
          height={280}
        />
      </Section>
      ...
      {/* Decision 01 */}
      <Section>
        <DotLabel color="#0284c7">Decision 01 — The Insight Card</DotLabel>
        <p style={prose} className="mb-5">
        ...
        <ImgBox
          label="Insights screen — HIGH IMPACT + MEDIUM IMPACT cards with 'Build this Brief' CTA"
          hexColor="#0284c7"
          height={360}
        />
      ...
      {/* Decision 02 */}
      <Section>
        <DotLabel color="#0284c7">Decision 02 — The FTUE Brief Agent</DotLabel>
        <p style={prose} className="mb-5">
        ...
        <ImgBox
          label="FTUE agent — seeded entry, chip-based exchanges, Copley proposes the brief"
          hexColor="#4f46e5"
          height={400}
        />
      ...
      {/* Decision 03 */}
      <Section>
        <DotLabel color="#0284c7">Decision 03 — The Dismissal Feedback Loop</DotLabel>
        <p style={prose} className="mb-5">
      ...
      <Section>
        ...
        <div className="mt-8">
          <DotLabel color="#0284c7">Language Audit</DotLabel>
        </div>
        <p style={prose} className="mb-8">
